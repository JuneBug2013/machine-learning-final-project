...
```
The accuracy is .7537.

The above comparsion shows that random forest did a better job in prediting the results than decision tree, therefore, it is choosen to predit on the test data. 
